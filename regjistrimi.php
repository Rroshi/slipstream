        ...
        <a href="index.php" class="nav-link" title="Services"><b class="sda"style="margin-left:-22px; margin-top:10px;">Slipstream Trainings</b></a>
         ...
         <div class="collapse navbar-collapse " id="myNavbar" style="text-align: center">
           ...
           <span class="searchh mr-lg-3">
               <i class="fas fa-user" style="color:#ffffff;"></i>&nbsp;<b style="color:#ffffff;">Login</b>
           </span>
         </a>
...
<br>
<center>
    <h3 style="color:#ff5733;"><b>Sign Up</b></h3>
    <br>
       <form id="contact-form" method="post" role="form">
            <div class="messages"></div>
                <div class="form-group">
                    <label for="emri"><h6><b>Emri</b></h6></label>
                    <input id="emri" type="text" name="emri" autocomplete="off" class="c-form inp" style="width:25%;">
                </div>
                <div class="form-group">
                  <label for="mbiemri"><h6><b>Mbiemri</b></h6></label>
                  <input id="mbiemri" type="text" name="mbiemri" autocomplete="off" class="c-form inp" style="width:25%;">
                </div>
                <div class="form-group">
                  <label for="email"><h6><b>Email</b></h6></label>
                  <input id="email" type="email" name="email" autocomplete="off" class="c-form inp" style="width:25%;">
                </div>
                <div class="form-group">
                  <label for="password"><h6><b>Password</b></h6></label>
                  <input id="password" type="text" name="password" autocomplete="off" class="c-form inp" style="width:25%;">
                </div>
                </center>
                <br>
                <center>
                <div class="form-group">
                    <center><label for="radio" class="rad"><h6><b>Gjinia</b></h6></label></center>
                    <input type="radio" name="gender" class="rad1" value="male" > <span>Mashkull</span>
                    <input type="radio" name="gender" class="rad" value="female" ><span> Femer</span>
                </div>
                <br>
                <div class="form-group">
                  <center><label for="radio" class="rad"><h6><b>Datelindja</b></h6></label></center>
                  <input type="date" id="birthday" name="birthday" class="c-form dtl">
                </div> 
                </center>
                <center><br>
                    <form action="function.php" method="POST" enctype="multipart/form-data">
                        <br>
                        <input type="submit" name="dergoni" class="btn" style="border: 4px solid #ffffff; color: #ffffff; background-color: #ff5733; font-weight:bold;" value="Regjistrohuni">
                    </form>
                    <div class="text-center" style="margin-top:12px; color:#ff5733;">Keni nje account? <a href="login.php" style="color:#ff5733; text-decoration:underline;"><b>Logohuni ketu</b></a></div>
                </center>
        </form>
</center>
...
<?php 
    if(isset($_POST['dergoni'])){
        ...
        $obj=new Ngarkoni();
        $res=$obj->ngarko($_POST);
        if($res==false){
            echo "<script>alert('Ju u regjistruat me sukses!! Tani mund te logoheni')</script>";
        }else{
            echo "<script>alert('Dicka shkoi keq!! Provoni perseri:(')</script>";
        }
    }
?>
<br>
